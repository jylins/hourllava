...
DATA_PATH="./experiments/streaming/hourllava_s2.yaml"
...
RUN_NAME="hourllava-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-s2" 
PREV_STAGE_CHECKPOINT="./work_dirs/hourllava/${S1_RUN_NAME}"
