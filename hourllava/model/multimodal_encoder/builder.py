...
def build_vision_tower(vision_tower_cfg, **kwargs):
    ...
    elif "siglip" in vision_tower or "siglip2" in vision_tower:
...
def build_text_tower(text_tower_cfg, **kwargs):
    if "siglip" in text_tower or "siglip2" in text_tower:
        return SigLipTextTower(text_tower, vision_tower_cfg=text_tower_cfg, **kwargs)
